...
n_init = 30  # Number of initial random points for the Bayesian optimization
n_iters = 60 # Number of iterations for the Bayesian optimization

# Select min and max values of each hyperparameters: [beta, annealing_time, gamma_0, n_trotters]
min_vals = [0.001, 1.0, 0.1, 10]
